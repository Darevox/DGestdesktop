...
Kirigami.Dialog {
    ...
    Kirigami.PromptDialog {
        ...
        customFooterActions: [
            Kirigami.Action {
                ...
                onTriggered: {
                    quoteModel.addPayment(dialogSaleId, {
    ...
    function saveSale() {
        ...
        if (isEditing) {
            quoteModel.updateSale(dialogSaleId, saleData);
        } else {
            quoteModel.createSale(saleData);
        }
    }
    ...
    Kirigami.PromptDialog {
        ...
        onAccepted: {
            quoteModel.convertToSale(dialogSaleId)
        }
    }
    ...
    Loader {
        ...
        sourceComponent: QuoteGenerationDialog {
            id: generationDialog
