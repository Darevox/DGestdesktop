...
Kirigami.PromptDialog {
    ...
    property var typesMapping: {
        "Purchase": "App/Models/Purchase",  // Use double backslashes
    ...
    function loadData(invoice) {
        ...
        invoiceableTypeCombo.currentIndex = invoiceableTypeCombo.model.indexOf(typesMapping[invoice.invoiceable_type]) || 0
